...
@section('content')
            ...
            <section id="product" class="py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="{{asset(''.$product->item_image.'')}}" alt="product" class="img-fluid">
                                   ...
                                   <!-- product qty section -->  
                                     <div class="qty d-flex">
                                         ...
                                         <div class="px-4 d-flex font-rale">
                                             <button class="qty-up border bg-light px-2" data-id="pro1"><i class="fas fa-angle-up"></i></button>
                                             <input type="text" data-id="pro1" class="qty_input border px-2 w-50 bg-light" disabled value="1" placeholder="1">
                                             <button data-id="pro1" class="qty-down border bg-light px-2"><i class="fas fa-angle-down"></i></button>
                                         </div>
                                     </div>
                                    <!-- !product qty section -->  
                                 </div>
